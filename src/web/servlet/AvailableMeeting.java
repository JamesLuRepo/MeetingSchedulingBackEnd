...
@WebServlet("/availableMeeting")
public class AvailableMeeting extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String email = request.getParameter("email");
        ScheduleShowService scheduleShowService = new ScheduleShowServiceImpl();
        ObjectMapper objectMapper = new ObjectMapper();
        List<ScheduleShow> allGps = scheduleShowService.getAvailableMeetingList(email);
